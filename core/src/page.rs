...
impl Page {
    ...
    pub async fn event_stream(&self, subscription: Subscription) -> impl Stream<Item = Arc<Event>> {
    ...
    pub async fn event(&self, subscription: Subscription, moment: u64) -> Result<(u64, Arc<Event>), u64> {
        let lagged = {
